      ...
      <div className="p-6">
        <div className="bg-gradient-to-br from-pink-50 to-purple-50 border border-pink-100 rounded-2xl p-5 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <button className="w-full py-2.5 bg-white hover:bg-gray-50 border border-gray-200 rounded-xl text-xs font-semibold text-gray-900 transition-colors shadow-sm">
              Upgrade Now
            </button>
          </div>
        </div>
